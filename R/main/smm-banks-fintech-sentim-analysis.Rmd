...
# Select only the emotional dimensions
# ba_resp_banks_mood <- dplyr::select(ba_resp_banks, anger, anticipation, disgust, fear, joy, sadness, surprise, trust)
# ba_resp_clients_mood <- dplyr::select(ba_resp_clients, anger, anticipation, disgust, fear, joy, sadness, surprise, trust)

# Cleaning of tweets classified with only zeros, not now
...
#Create data
name=c(3,10,10,3,6,7,8,3)
feature=paste("feature ", c(1,1,2,2,3,3,4,4) , sep="")
