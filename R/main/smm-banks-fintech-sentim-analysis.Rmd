...
# Create list of dataframes of each account
fintech_list = list()
...
### Kudos to https://www.datacamp.com/community/tutorials/sentiment-analysis-R
```{r}
# Load data
...
### Create sentiment datasets (bing, nrc, nrc polarity)
### Kudos to https://www.datacamp.com/community/tutorials/sentiment-analysis-R
```{r}
