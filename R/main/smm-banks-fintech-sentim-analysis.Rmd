...
gl_auth("../../.Google-NLP-API-Key.json")
...
### Methodology adapted from Garcia (2018)
```{r}
...
## H4 Testing: H4: Companies in the Swiss FinTech sector have a more positive polarity score measured on client responses of corporate tweets than Swiss banking companies.
...
nlp_result <- gl_nlp(banks_data_retweets$text)
