...
### FinTech - SYUZHET method (The SELECTED one)
```{r}
...
ft_alltweets_clean = unique(ft_alltweets_clean) # del redundant tweets?
...
# TODO: Description TWEET or RETWEET, instead of FALSE / TRUE
#Define some colors to use throughout
my_colors <- c("#E69F00", "#56B4E9", "#009E73", "#CC79A7", "#D55E00", "#D65E00", "#6C5B7B", "#355C7D")
grid.col = c("TRUE" = "grey", "FALSE" = "grey", "anger" = my_colors[1], "anticipation" = my_colors[2], "disgust" = my_colors[3], "fear" = my_colors[4], "joy" = my_colors[5], "sadness" = my_colors[6], "surprise" = my_colors[7], "trust" = my_colors[8])
...
# 1. Prep data to clean tweets (whole sentences), undertake sentiment analysis based on tweets
ba_retweets_clean <- cleanTweets(banks_data_retweets$text)
...
# TODO
# 1. Testing for normal distribution (Shapiro-Wilk) for emotional dimension score: Trust. Both sectors, banks vs. FinTech
# 2. Testing via t-test or Wilcoxon
# 3. Results
