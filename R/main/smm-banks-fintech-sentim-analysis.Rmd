...
title("Banking: Emotional Relationships - Tweets and Responses")
dev.off()
...
title("FinTech: Emotional Relationships - Tweets and Responses")
dev.off()
...
ba_resp_mood <- ba_df %>%
  filter(from == "R_trust")  # Only take trust responses
#  group_by(from, to) %>%
#  summarise(value = sum(value)) %>%
#  arrange(from, to) %>%
#  ungroup()
