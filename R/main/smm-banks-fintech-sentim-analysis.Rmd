...
ggplot(ba_ft_syu_wcox_melt) +
  ...
  labs(x = "Emotion", y = "NLP classifed emotional score",
       title="Emotional Score of Trust Retweets Compared to Entity Type")+
  scale_color_discrete(name="Entity Type")+
  coord_flip()
...
ggplot(ba_ft_resp_all) +
  ...
  labs(y = "NLP classified emotional score", x = "Emotion",
       title="Emotional Score of Trust Responses Compared to Entity Type")+
  scale_color_discrete(name="Entity Type")+
  coord_flip()
