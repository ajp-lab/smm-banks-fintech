...
# Chart: Social Media Activity Ratio Per Category
...
ggplot(dfmf_ratio, aes(x=(variable), y=log10(value)) ) + 
  ...
  labs(y="Ratio (log10 scale)", 
       x="Social Media Activity", 
       title="Social Media Activity Ratio Normalized on Employee Size")+
  scale_color_discrete(name="Type") +
  scale_size_continuous(name="Employee size")+
  scale_x_discrete(labels=SocMedActLabs)+
  theme(axis.text.x = element_text(angle=45, vjust=0.5, size=10))

ggsave("../../img/charts-normalized/chart1_sma_ratio_norm_on_empl_size.png")
